...
data = kvudp.set('MR0')
print(data)
data = kvudp.reset('MR1')
print(data)
data = kvudp.sts('MR10', 5)
print(data)
data = kvudp.rss('MR10', 4)
print(data)
data = kvudp.read('DM0.U')
print(data)
data = kvudp.reads('DM0.S', 4)
print(data)
data = kvudp.write('DM0.U', '2')
print(data)
data = kvudp.writs('DM1.S', 4, '1 2 3 4')
print(data)
